import{_ as i,c as a,a5 as n,o as l}from"./chunks/framework.O9ad3XaM.js";const d=JSON.parse('{"title":"velocity.toml","description":"","frontmatter":{"title":"velocity.toml","sidebar_position":2},"headers":[],"relativePath":"Java/process/cross-server/build-up/Velocity/velocity.toml.md","filePath":"nitwikit/docs-java/process/cross-server/build-up/Velocity/velocity.toml.md","lastUpdated":1749617524000}'),p={name:"Java/process/cross-server/build-up/Velocity/velocity.toml.md"};function e(t,s,h,k,r,c){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h1><p>以下配置仅为汉化参考，<strong>请勿直接复制！！</strong></p><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 配置版本。不要更改这个</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 代理应该绑定到哪个端口？默认情况下，我们将绑定到 25577 端口的所有地址。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应该显示什么 MOTD(服务器消息)？当玩家将你的服务器添加到他们的服务器列表时，会显示这个。只接受 MiniMessage 格式。</span></span>
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">motd = </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&lt;#09add3&gt;一个 Velocity 服务器&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 我们应该显示多少最大玩家数？(Velocity 不支持在线玩家数的限制。)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 我们应该使用 Mojang 对玩家进行身份验证吗 (译者注：正版验证)？默认情况下，这是开启的。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果从这个代理发送的客户端的 ISP/AS 与 Mojang 的认证服务器的不同，玩家将被踢出。这禁止了一些 VPN 和代理连接，但这是一种较弱的保护形式。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 我们应该将 IP 地址和其他数据转发到后端服务器吗？</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 可用选项：</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;none&quot;:        不会进行任何转发。所有玩家看起来都是从代理连接的，并且将拥有离线模式的 UUID。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;legacy&quot;:      以 BungeeCord 兼容格式转发玩家 IP 和 UUID。如果你运行的是 Minecraft 1.12 或更低版本的服务器，请使用此选项。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;bungeeguard&quot;: 以 BungeeGuard 插件支持的格式转发玩家 IP 和 UUID。如果你运行的是 Minecraft 1.12 或更低版本的服务器，并且无法实现网络级防火墙 (在共享主机上)，请使用此选项。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;modern&quot;:      使用 Velocity 的原生转发，在登录过程中转发玩家 IP 和 UUID。仅适用于 Minecraft 1.13 或更高版本。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果你使用 modern 或 BungeeGuard IP 转发，请在此处配置包含唯一密钥的文件。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 文件应该是 UTF-8 编码的，并且不为空。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 宣布你的服务器是否支持 Forge。如果你运行一个模组服务器，我们建议开启这个。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果你的网络持续运行一个模组包，考虑使用 ping-passthrough = &quot;mods&quot;代替，以便在服务器列表中更好地显示。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果启用 (默认为 false)，并且代理处于在线模式，Velocity 将踢出任何已在线的玩家，如果尝试进行重复连接。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Velocity 是否应该将服务器列表 ping 请求传递给后端服务器？</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 可用选项：</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;disabled&quot;:    不会进行任何传递。velocity.toml 和 server-icon.png 将决定初始服务器列表 ping 响应。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;mods&quot;:        只将后端服务器的模组列表传递到响应中。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#                  使用你尝试列表中的第一个服务器 (或强制主机) 的模组列表。如果无法联系到后端服务器，Velocity 将不会显示任何模组信息。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># - &quot;all&quot;:         使用后端服务器的响应作为代理响应。如果没有服务器可以联系，将使用 Velocity 配置。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果未启用 (默认为 true)，玩家 IP 地址将被替换为&lt;ip address withheld&gt;在日志中</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在此处配置你的服务器。每个键代表服务器的名称，值代表要连接到的服务器的 IP 地址。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Minecraft 数据包必须有多大，我们才会压缩它。将其设置为零将压缩所有数据包，将其设置为 -1 将完全禁用压缩。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 应该进行多少压缩 (从 0-9)。默认是 -1，使用默认级别 6。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 客户端在上次连接后允许多快连接 (以毫秒为单位)？默认是三秒。通过将其设置为 0 来禁用此功能。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在此处指定连接的读取超时时间。默认是 30 秒。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 启用与 HAProxy 的 PROXY 协议的兼容性。如果你不知道这是干什么用的，那么就不要启用它。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在代理上启用 TCP 快速打开支持。需要代理在 Linux 上运行。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在 Velocity 上启用 BungeeCord 插件消息通道支持。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 显示来自客户端的 ping 请求到代理。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 默认情况下，Velocity 将尝试优雅地处理用户意外失去与服务器的连接而没有明确的断开消息的情况，通过尝试回退用户，除了读取超时的情况。BungeeCord 将断开用户连接。你可以禁用此设置以使用 BungeeCord 的行为。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 向 1.13+ 客户端声明代理命令。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 允许通过 Transfer 数据包 (Minecraft 1.20.5) 从其他主机传输的玩家被接收。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否启用对 GameSpy 4 查询响应的响应。</span></span>
