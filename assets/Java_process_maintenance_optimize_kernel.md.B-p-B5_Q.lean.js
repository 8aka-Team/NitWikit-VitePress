...
<span class="line"><span># 系统同时保持TIME_WAIT套接字的最大数量</span></span>
...
<span class="line"><span># 默认情况下一个 TCP 连接关闭后, 把这个连接曾经有的参数保存到dst_entry中</span></span>
...
<span class="line"><span># 系统所能处理不属于任何进程的TCP sockets最大数量</span></span>
<span class="line"><span>net.ipv4.tcp_max_orphans=3276800</span></span>
<span class="line"><span># arp_table的缓存限制优化</span></span>
...
<span class="line"><span># 允许更多的PIDs, 减少滚动翻转问题</span></span>
...
<span class="line"><span># 设定程序core时生成的文件名格式</span></span>
<span class="line"><span>kernel.core_pattern=core_%e</span></span>
<span class="line"><span># 当发生oom时, 自动转换为panic</span></span>
<span class="line"><span>vm.panic_on_oom=1</span></span>
<span class="line"><span># 表示强制Linux VM最低保留多少空闲内存（Kbytes）</span></span>
<span class="line"><span># vm.min_free_kbytes=1048576</span></span>
<span class="line"><span># 该值高于100, 则将导致内核倾向于回收directory和inode cache</span></span>
...
<span class="line"><span># 仅用10%做为系统cache</span></span>
...
<span class="line"><span># 开启F-RTO(针对TCP重传超时的增强的恢复算法).</span></span>
...
<span class="line"><span># TCP内存自动调整</span></span>
<span class="line"><span>net.ipv4.tcp_moderate_rcvbuf = 1</span></span>
<span class="line"><span># 单个TSO段可消耗拥塞窗口的比例, 默认值为 3</span></span>
