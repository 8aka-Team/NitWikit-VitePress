import{_ as i,c as a,a5 as n,o as l}from"./chunks/framework.O9ad3XaM.js";const g=JSON.parse('{"title":"config.yml","description":"","frontmatter":{"title":"config.yml","sidebar_position":3},"headers":[],"relativePath":"Java/process/plugin/ManageTool/BasicPlugins/EssentialsX/config.yml.md","filePath":"nitwikit/docs-java/process/plugin/ManageTool/BasicPlugins/EssentialsX/config.yml.md","lastUpdated":1749617524000}'),p={name:"Java/process/plugin/ManageTool/BasicPlugins/EssentialsX/config.yml.md"};function h(k,s,e,t,r,E){return l(),a("div",null,s[0]||(s[0]=[n(`<div class="language-yaml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">yaml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#-驿站忆行 (185839426)</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">############################################################</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># OP 名字的颜色代码，填写 0~9 或 a~f 其中的一个数字或字母，填写&#39;none&#39;来冻结该功能</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 拥有 essentials.nick.blacklist.bypass 的用户将能够绕过此过滤器。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 启用此选项时，TAB 玩家列表将使用显示名称更新。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 上方 change-displayname (above) 必须为 true.</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#change-playerlist: true</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 添加前缀后缀 (上面的&quot;change-displayname&quot;必须是 true 才有效)</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果你不设置该项，且 essentialschat 被安装了，其将会被默认为&quot;true&quot;.</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果此项设置为 true，则会尝试传送玩家到最近的安全地点</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果设置为 false，将会取消传送并发送一则警告消息</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 延迟，以秒为单位， 比如使用 /heal 或 /feed attempts. 驿站:heal 命令是治愈玩家</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置下方的数字即为输入/near 时可查询到的范围内的玩家。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 禁止作弊命令/give， /item 调出的物品黑名单列表。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 例如 item-spawn-blacklist: 46，11，10  驿站觉得这功能没必要 a</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用/spawnmob 命令一次性生成生物的最大数量。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否提醒玩家有无新邮件 (true 为提醒，false 为不提醒)</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 当一个命令与其它插件冲突，Essentials 基础插件会默认尝试强行让其它插件获得优先权。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果一个命令在列表中，Essentials 基础插件会尝试给默认的命令优先权。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 通常哪一个插件将胜出的几率是随机的。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果你有两个插件并且命令相同而且你希望使用 essentials，那么你需要了解 命令别名 (alias).</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 这些命令是当开启了/socialspy 命令时可以看到的玩家私聊</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果玩家没有 essentials.fly，这将禁用飞行。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果没有 essentials.speed，这会将玩家的速度重置为默认值。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果玩家没有 essentials.speed.bypass，这会将他们的速度重置为上面指定的最大值。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用此选项强制基于 op 权限的权限处理程序，而不管检测到已安装的权限插件。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 将从玩家的 kit 列表中删去该项可用工具包</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 启用后，只要玩家的盔甲槽是空的，就会自动装备领取的 kit 包中的盔甲。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果这是 true，/createkit 将给用户一个带有 kit 代码的链接。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果为 false，/createkit 将直接将该 kit 工具包添加到 kits.yml 配置文件中。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 默认为 false。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 默认为 false。应该是说，开启后 kit 可以存 nbt 的东西了</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 数值用该在 1-20 之间，20 将几乎没有间隔。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果为 true，即使没有玩家在线，备份任务也会运行。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 当使用/list 命令时，将玩家按组分类。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 你可以隐藏或合并组，在下面设定/list 的分类。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在使用昵称的玩家旁边显示 /list 中的真实 ID。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 例如，使用中文语言文件，设置 locale 为 zh，即可使用语言文件&quot;messages_zh.properties&quot;</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 此功能需要玩家拥有 essentials.afk.auto 节点。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 将此设置为 true，如果玩家是 AFK，冻结玩家，如果玩家是 AFK。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 当玩家 AFK 时，是否能够捡起物品</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 此设置控制玩家是否在交互时自动退出 afk 模式。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 此设置为 false 时，如果有玩家在 AFK，玩家将无法跳过夜晚。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置玩家 AFK 时的列表名称。默认情况下为 none，它指定 Essentials</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 不应干扰 AFK 玩家的列表名称。none 我改成了 挂机中</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 当玩家进入或退出 AFK 模式时，是否聊天栏通知其他玩家</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 发给整个服务器的人，还是只发给这个挂机的玩家？</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 当此设置为 false 时，只有准备挂机的玩家会收到 afk 通知</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 此外，拥有 essentials.silentjoin.vanish 的人将在加入时消失。</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">custom-join-message</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&amp;e[&amp;a+&amp;e]&amp;6 比驿站丑的 {USERNAME} 加入了游戏&quot;</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">custom-quit-message</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&amp;e[&amp;c-&amp;e]&amp;6 比驿站丑的 {USERNAME} 退出了游戏&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 你可以在此处为新玩家 (和更换 ID 的老玩家？) 设置加入提示。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># {UNIQUE} - 加入服务器的唯一玩家数量。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># {UPTIME} - 服务器运行时间</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">custom-new-username-message</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&quot;&amp;e[&amp;a+&amp;e]&amp;6 比驿站丑的新玩家 {USERNAME} 加入了游戏&quot;</span></span>
<span class="line"></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置为 true，启用每个世界传送单独的权限。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 若在使用/give 或/item 命令时如果没有填写数量。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果这个数值设置小于 1，那么给予最大叠加数量的物品</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果超大堆叠没有开启，那么数量大于正常堆叠数量 (64) 时，将给予 1 组以上物品。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果玩家拥有 essentials.oversizedstacks 权限，当使用 /give 或 /item 时可以获得超大堆叠物品。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果设置为 false，你仍然可以允许某些玩家修理。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 使用 essentials.repair.enchanted 权限</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 在 kits 和物品生成时，允许 &#39;不安全的&#39; 附魔。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 是否想要 essentials 插件保留 /back 坐标在&quot;teleport listener&quot;?</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果你设置为 true，一些插件可以获得传送坐标。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果为 true，/reply 将不会检查你正在回复的人是否已经消失。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 允许某人使用 essentials.time.world.&lt;worldname&gt; 传送到一个世界。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 例如，要针对以 ban 而不是 banip 开头的命令，将使用以下命令：</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># NPC 余额是否应该在余额排名功能中列出，例如/balancetop。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 默认为空，最新的有效命令列表见最新的源码 config.yml。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 玩家拥有多个家需要有 essentials.sethome.multiple 权限，默认 &#39;default&#39; 下面。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 如果设置为 false，玩家在没有设置家的情况下运行/home 时不会被传送。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 一些命令例如/repair 拥有独立的花费，可以在 essentials wiki 查看更多信息</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 这个数量最大为 10 万亿 (1 个 1，13 个 0)，这是由于 JAVA 的限制。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置为 0，将完全禁用透支/贷款。用户需要&#39;essentials.eco.loan&quot;权限，钱数才能低于 0.</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置为 true 来记录所有玩家的交易记录 (译注，仅记录 Essentials 所支持的交易命令和功能).</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 货币格式，不包括符号。有关符号配置，请参阅 currency-symbol-format-locale。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 个人权限设置是:essentials.help.&lt;plugin&gt;，任何人有 essentials.*或&#39;*&#39;将能看到所有帮助.</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">############################################################</span></span>
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 你需要安装 EssentialsChat.jar！.还有，不推荐 ess 全家桶，用别的聊天插件吧</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置聊天半径，如果安装了 EssentialsChat，这将设置玩家喊话的可见范围，以格为单位。设置为 0 则允许全图聊天。</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 玩家的喊叫模式是否应该持续重启。 (野兽前辈的喊叫模式嘛 awa)</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  prevent</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">:  </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 阻止以下现象 (译注:true 就是阻止，false 是允许，这里需要注意一下)</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    portal-creation</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # 阻止 TNT 的爆炸</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    tnt-explosion</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # 阻止 TNT 对玩家造成伤害</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    tnt-playerdamage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # 阻止 TNT 矿车 爆炸</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    tnt-minecart-explosion</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # 阻止 TNT 矿车 爆炸</span></span>
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    tnt-minecart-playerdamage</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">false</span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">   # 阻止 TNT 矿车 对玩家造成伤害</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # 若改为 true，怪物将不会跟随玩家</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # 爬行者可以爆炸的最大高度，-1 将允许它在任何位置爆炸。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # 如果你想要彻底阻止它的爆炸的话，设置上面的 prevent 一栏中的 creeper-explosion 为 true.</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">    # 若设置为 true，没有上述权限的玩家将无法攻击其他玩家</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">  # 你加载了一次 Essentials 后，就可以在 plugins/Essentials/items.csv 中找到物品 ID 列表。</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">  announce-format</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">&#39;&amp;7[&amp;b 驿站&amp;7]&amp;a 欢迎大傻蛋来服务器！&#39;</span></span>
<span class="line"></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置为 high，如果你想使用 EssentialsSpawn 插件 处理重生。</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 设置为 highest，如果你想强制使用 EssentialsSpawn 插件 处理重生。</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># respawn-at-home(上图) 的值必须为 true</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 文件结尾 &lt;-- 到此，你已经完成了 ESS 的设置。</span></span></code></pre></div>`,1)]))}const y=i(p,[["render",h]]);export{g as __pageData,y as default};
