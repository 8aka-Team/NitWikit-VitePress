import{_ as i,c as a,a5 as n,o as l}from"./chunks/framework.Dzz2jpra.js";const d=JSON.parse('{"title":"velocity.toml","description":"","frontmatter":{"title":"velocity.toml","sidebar_position":3},"headers":[],"relativePath":"nitwikit/docs-java/advance/cross-server/build-up/Velocity/velocity.toml.md","filePath":"nitwikit/docs-java/advance/cross-server/build-up/Velocity/velocity.toml.md","lastUpdated":1730968765000}'),p={name:"nitwikit/docs-java/advance/cross-server/build-up/Velocity/velocity.toml.md"};function e(t,s,h,k,r,c){return l(),a("div",null,s[0]||(s[0]=[n(`<h1 id="配置文件" tabindex="-1">配置文件 <a class="header-anchor" href="#配置文件" aria-label="Permalink to &quot;配置文件&quot;">​</a></h1><p>以下配置仅为汉化参考 ，<strong>请勿直接复制！！</strong></p><div class="language-toml vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">toml</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 配置版本。不要更改这个</span></span>
